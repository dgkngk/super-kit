...
- **[Compound Engineering Loop](../skills/workflows/compound.md)**: How the Super-Kit workflow operates.
...
- **Skills (`/skills`)**: Technical (`tech`) and Meta (`meta`) skills, plus internal **Workflows** (`workflows`) that the agents can dynamically load as context.
- **Commands (`/commands`)**: Standard operating procedures executed via TOML slash commands.
